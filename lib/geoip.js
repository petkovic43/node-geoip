...
function lookup6(ip) {
    return new Promise(function(resolve, reject) {
        ...
        if (utils.cmp6(ip, cache6.lastIP) > 0 || utils.cmp6(ip, cache6.firstIP) < 0) {
            return reject({ error: 'outside of range' });
        }
...
module.exports = {
    ...
    lookup: function(ip) {
        ...
        if (!ip) {
            ...
            return ipv4 ? lookup4(utils.aton4(ipv4)) : lookup6(utils.aton6(ip));
        } else {
